...
{
	public static function construirExpediente(Especialidad $especialidad)
	{
		switch ($especialidad->getId()) {
			case 3:
				return new ExpedienteOdontopediatria();
				break;
	...
	/**
	 * construir expediente de captura
	 * @param  Request 		$request
	 * @param  Especialidad $especialidad
	 * @return Expediente
	 */
	public static function construirExpedienteCaptura(Request $request, Especialidad $especialidad)
	{
		////////////////
		// 1a pestaña //
		////////////////
