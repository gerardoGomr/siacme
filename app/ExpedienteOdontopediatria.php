...
require_once "ComportamientoInicial.php";
require_once "ComportamientoFrankl.php";
require_once "MorfologiaCraneoFacial.php";
require_once "MorfologiaFacial.php";
require_once "ConvexividadFacial.php";
require_once "ATM.php";
require_once "ExpedienteOdontopediatriaBD.php";
...
class ExpedienteOdontopediatria extends Expediente
{
	...
	{
		$expedienteOdontopediatriaBD = new ExpedienteOdontopediatriaBD();
		return $expedienteOdontopediatriaBD->cargarDatos($this);	
	}

	public function guardarDatos() 
	{
		$expedienteOdontopediatriaBD = new ExpedienteOdontopediatriaBD();
		return $expedienteOdontopediatriaBD->guardarDatos($this);
	}

	public function editarDatos() 
	{
		$expedienteOdontopediatriaBD = new ExpedienteOdontopediatriaBD();
		return $expedienteOdontopediatriaBD->editarDatos($this);
	}
}