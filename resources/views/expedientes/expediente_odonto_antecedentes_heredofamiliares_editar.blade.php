				...
				<div class="row">
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							{!! Form::text('txtCausaMuerteMadre', $expediente->getCausaMuerteMadre(), ['class' => 'form-control', 'readonly' => 'readonly']) !!}
						</div>
					</div>
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							{!! Form::text('txtEnfermedadesMadre', $expediente->getEnfermedadesMadre(), ['class' => 'form-control']) !!}
						</div>
					</div>
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							{!! Form::text('txtCausaMuertePadre', $expediente->getCausaMuertePadre(), ['class' => 'form-control', 'readonly' => 'readonly']) !!}
						</div>
					</div>
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							{!! Form::text('txtEnfermedadesPadre', $expediente->getEnfermedadesPadre(), ['class' => 'form-control']) !!}
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-group">
							...
							{!! Form::textarea('txtEnfermedadesAbuelosPaternos', $expediente->getEnfermedadesAbuelosPaternos(), ['class' => 'form-control', 'rows' => '6']) !!}
						</div>
					</div>
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							{!! Form::textarea('txtEnfermedadesAbuelosMaternos', $expediente->getEnfermedadesAbuelosMaternos(), ['class' => 'form-control', 'rows' => '6']) !!}
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							...
							{!! Form::text('txtNumHermanos', $expediente->getNumHermanos(), ['class' => 'form-control']) !!}
						</div>
					</div>
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							{!! Form::text('txtNumHermanosVivos', $expediente->getNumHermanosVivos(), ['class' => 'form-control']) !!}
						</div>
					</div>
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							{!! Form::text('txtNumHermanosFinados', $expediente->getNumHermanosFinados(), ['class' => 'form-control', 'readonly' => 'readonly']) !!}
						</div>
					</div>
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							{!! Form::textarea('txtNombresEdades', $expediente->getNombreEdadesHermanos(), ['class' => 'form-control', 'rows' => '6']) !!}
						</div>
					</div>
					...
					<div class="col-xs-12">
						<div class="form-group">
							...
							{!! Form::textarea('txtEnfermedadesHermanos', $expediente->getEnfermedadesHermanos(), ['class' => 'form-control', 'rows' => '6']) !!}
						</div>
					</div>
				</div>
